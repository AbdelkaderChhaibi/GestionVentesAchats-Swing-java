...
public class FenetreAjoutBR extends JFrame {
	...
	public FenetreAjoutBR() {
		...
		jtable=new JTable(data, col);
		  ...
		  jp2.add(new JLabel("fournisseur"));
		  jp3.add(new JLabel("datebon"));
	...
	public BonReception getBR(){
		...
		BonReception br=new BonReception(code, fournisseur, dateBon, dateReception, adress, infoRelative, vp);
		return br;
		
	}
	public void remplirBR(BonReception br) {
